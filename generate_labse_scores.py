...
def main(args):
    ...
    with open(os.path.join(args.folder, args.lang_pair, f'train.{src_lang}'), "r", encoding='utf-8') as f1, \
         open(os.path.join(args.folder, args.lang_pair, f'train.{tgt_lang}'), "r", encoding='utf-8') as f2 :
    ...
    with open(os.path.join(args.folder, args.lang_pair, 'labse.txt'), "w") as f:
