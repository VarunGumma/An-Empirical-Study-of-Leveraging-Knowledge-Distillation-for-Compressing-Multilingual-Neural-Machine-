#! /bin/bash
#SBATCH --job-name global-multi-level-adaptive-distil
#SBATCH --nodes 1
...
--task kd_translation --kd-strategy global_multi_level --teacher-checkpoint-path indic-en/model_4x_checkpoint_best.pt \
--criterion kd_label_smoothed_cross_entropy --label-smoothing 0.1 --alpha 0.5 --use-adaptive-kd-rates --kd-queue-size 50000 --teacher-temp 2.5 --student-temp 2.5 --kd-selection-temp 1.5 \
...
--save-dir indic-en-exp/model-1x-gelu-norm-global-multi-adaptive-disti:l --save-interval 1 --keep-last-epochs 1 --patience 5 \
