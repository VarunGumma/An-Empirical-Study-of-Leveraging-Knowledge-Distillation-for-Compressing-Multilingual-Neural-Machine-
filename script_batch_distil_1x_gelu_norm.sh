#! /bin/bash
#SBATCH --job-name batch-level-distil
#SBATCH --nodes 1
...
--task kd_translation --kd-strategy batch_level --teacher-checkpoint-path indic-en/model_4x_checkpoint_best.pt \
--criterion kd_label_smoothed_cross_entropy --label-smoothing 0.1 --alpha 0.5 --kd-rate 0.5 --teacher-temp 2.5 --student-temp 2.5 \
...
--save-dir indic-en-exp/model-1x-gelu-norm-batch-distil --save-interval 1 --keep-last-epochs 1 --patience 5 \
