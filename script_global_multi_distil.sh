#! /bin/bash
#SBATCH --job-name global-multi-distil
#SBATCH --nodes 1
...
--task translation --kd-strategy global_multi_level --teacher-checkpoint-path checkpoints/indicTrans/checkpoint_best.pt \
--criterion label_smoothed_cross_entropy_with_kd --label-smoothing 0.1 --alpha 0.5 --kd-rate 0.5 --kd-queue-size 50000 \
...
--save-dir checkpoints/global-multi-distil --save-interval 1 --keep-last-epochs 1 --patience 5 \
...
--user-dir indicTrans/model_configs > logs/global_multi_distil.log
