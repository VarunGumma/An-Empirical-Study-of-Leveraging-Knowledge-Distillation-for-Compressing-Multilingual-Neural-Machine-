...
--task kd_translation --kd-strategy global_level --teacher-checkpoint-path checkpoints/indicTrans/checkpoint_best.pt \
--criterion kd_label_smoothed_cross_entropy --label-smoothing 0.1 --alpha 0.5 --kd-rate 0.5 --kd-queue-size 50000 \
...
--save-dir indic-en-exp/global-distil --save-interval 1 --keep-last-epochs 1 --patience 5 \
