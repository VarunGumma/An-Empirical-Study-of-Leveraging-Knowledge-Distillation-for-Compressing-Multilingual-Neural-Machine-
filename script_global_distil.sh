...
--task translation --kd-strategy global_level --teacher-checkpoint-path checkpoints/indicTrans/checkpoint_best.pt \
...
--save-dir checkpoints/global-distil --save-interval 1 --keep-last-epochs 1 --patience 5 \
