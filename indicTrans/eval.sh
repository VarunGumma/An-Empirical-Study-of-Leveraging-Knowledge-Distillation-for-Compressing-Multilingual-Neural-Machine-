...
for ext in "${allArgs[@]}"; do
    ...
    for lang in bn gu hi kn ml mr or pa ta te; do
        ./joint_translate.sh $ext ../benchmarks/wat2021-devtest/en-$lang/test.$lang ../benchmarks/wat2021-devtest/en-$lang/outfile.en $lang en ../indic-en-exp 
    ...
    for lang in bn gu hi ml mr ta te; do
        ./joint_translate.sh $ext ../benchmarks/wat2020-devtest/en-$lang/test.$lang ../benchmarks/wat2020-devtest/en-$lang/outfile.en $lang en ../indic-en-exp
    ...
    for lang in gu hi ta; do
        ./joint_translate.sh $ext ../benchmarks/wmt-news/en-$lang/test.$lang ../benchmarks/wmt-news/en-$lang/outfile.en $lang en ../indic-en-exp
    ...
    # ufal
    echo ">>>>> UFAL"
    ./joint_translate.sh $ext ../benchmarks/ufal-ta/en-ta/test.ta ../benchmarks/ufal-ta/en-ta/outfile.en ta en ../indic-en-exp
    ...
    # PMI
    echo ">>>>> PMI"
    ./joint_translate.sh $ext ../benchmarks/pmi/en-as/test.as ../benchmarks/pmi/en-as/outfile.en as en ../indic-en-exp
    ...
    for lang in as bn gu hi kn ml mr or pa ta te; do
        ./joint_translate.sh $ext ../benchmarks/flores101_dataset/en-$lang/test.$lang ../benchmarks/flores101_dataset/en-$lang/outfile.en $lang en ../indic-en-exp
