...
--task kd_translation --kd-strategy word_and_seq_level --teacher-checkpoint-path indic-en/model-4x/checkpoint_best.pt \
--criterion kd_label_smoothed_cross_entropy --label-smoothing 0.1 --teacher-temp 2.5 --student-temp 2.5 --use-adaptive-weightage --adaptive-smoothing 0.5 \
...
--save-dir indic-en-exp/model-1x-gelu-norm-adaptive-distil --save-interval 1 --keep-last-epochs 1 --patience 5 \
