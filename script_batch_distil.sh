...
--task translation --kd-strategy batch_level --teacher-checkpoint-path checkpoints/indicTrans/checkpoint_best.pt \
--criterion label_smoothed_cross_entropy_with_kd --label-smoothing 0.1 --alpha 0.5 --kd-rate 0.5 \
...
--save-dir checkpoints/batch-distil --save-interval 1 --keep-last-epochs 1 --patience 5 \
