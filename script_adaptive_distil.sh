...
--criterion label_smoothed_cross_entropy_with_kd --label-smoothing 0.1 --use-adaptive-weightage --adaptive-smoothing 0.5 \
...
--save-dir checkpoints/adaptive-distil --save-interval 1 --keep-last-epochs 1 --patience 5 \
