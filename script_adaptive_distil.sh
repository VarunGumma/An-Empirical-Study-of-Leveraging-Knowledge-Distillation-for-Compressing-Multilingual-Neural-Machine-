...
--task kd_translation --kd-strategy word_and_seq_level --teacher-checkpoint-path checkpoints/indicTrans/checkpoint_best.pt \
--criterion kd_label_smoothed_cross_entropy --label-smoothing 0.1 --use-adaptive-weightage --adaptive-smoothing 0.5 \
