#! /bin/bash
#SBATCH --job-name global-level-distil
#SBATCH --nodes 1
...
--task kd_translation --kd-strategy global_level --teacher-checkpoint-path indic-en/model_4x_checkpoint_best.pt \
...
--save-dir indic-en-exp/model-1x-gelu-norm-global-distil --save-interval 1 --keep-last-epochs 1 --patience 5 \
