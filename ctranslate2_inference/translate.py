...
parser.add_argument('--model', '-m', help='model name; this ct2-converted model should be present in the experiment directory')
...
for lang_pair in sorted(listdir(devtest_dir)):
    ...
    with open(f"{devtest_dir}/{lang_pair}/test.{tgt}.pred.{args.model_name}", 'w', encoding='utf-8') as f:
