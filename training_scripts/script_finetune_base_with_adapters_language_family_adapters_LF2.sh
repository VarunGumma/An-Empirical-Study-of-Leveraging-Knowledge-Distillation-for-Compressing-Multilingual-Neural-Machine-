...
save_to_dir="V_base_with_language_family_adapters_LF2_finetuned_on"
...
for lang in as bn gu hi kn ml mr or pa ta te; do
    ...
    --encoder-adapter-lang-ids "[\"mr:hi:gu\", \"hi:pa\", \"as:bn\", \"bn:or\", \"ta:ml:te:kn\", \"ta:ml\", \"te:kn\"]" \
    --encoder-finetune-adapter $lang \
    --decoder-add-adapters \
    --decoder-adapter-reduction-factor-trend "[2, 4, 8, 8, 4, 2]" \
    --decoder-adapter-lang-ids "[\"mr:hi:gu\", \"hi:pa\", \"as:bn\", \"bn:or\", \"ta:ml:te:kn\", \"ta:ml\", \"te:kn\"]" \
