...
bash prepare_data_joint_training.sh $exp_dir $src_lang $tgt_lang $languages_list sep $exp_dir $exp_dir/devtest/all $reuse_bpe_vocab $vocab_bpe_dir $transliterate $num_operations
