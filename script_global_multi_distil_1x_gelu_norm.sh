#! /bin/bash
#SBATCH --job-name global-multi-level-distil
#SBATCH --nodes 1
...
--criterion kd_label_smoothed_cross_entropy --label-smoothing 0.1 --alpha 0.5 --kd-rate 0.5 --kd-queue-size 50000 --teacher-temp 2.5 --student-temp 2.5 \
...
--save-dir indic-en-exp/model-1x-gelu-norm-global-multi-distil --save-interval 1 --keep-last-epochs 1 --patience 5 \
